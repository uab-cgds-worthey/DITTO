...
if __name__ == "__main__":
    ...
    config = {  # https://stackoverflow.com/questions/61502257/optimize-hyperparameters-hidden-layer-size-mlpclassifier-with-skopt
        ...
        "max_iter": hp.randint("max_iter", 10, 1000),
    ...
    # config["hidden_layer_sizes"] = tuple([hp.randint("n_neurons", 1, 300) for i in range(hp.randint("n_layers", 1, 50))])
