...
if __name__ == '__main__':
    ...
    analysis = run(
        ...
        name=f'GradientBoostingClassifier_{var}',
        verbose=1,
        #scheduler=scheduler,
    ...
    print(f'GradientBoostingClassifier_{var}:  {config}', file=open(f'../tuning/tuned_parameters.csv', 'a'))
