...
if __name__ == '__main__':
    ...
    analysis = run(
        ...
        name=f'ExtraTreesClassifier_{var}',
        verbose=1,
        #scheduler=scheduler,
    ...
    print(f'ExtraTreesClassifier_{var}:  {config}', file=open(f'../tuning/tuned_parameters.csv', 'a'))
