...
class ET_PB2(Trainable):  #https://docs.ray.io/en/master/tune/examples/pbt_tune_cifar10_with_keras.html
    ...
    def results(self,config,var, output):
        ...
        del background, shap_values, self.x_test, self.feature_names
        return None
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="non_snv",
        help="Type of variation to tune the classifier (snv, non_snv, snv_protein_coding). (Default: non_snv)")
